...
export default class Trimmer extends React.Component {
  ...
  render() {
    ...
    if (isNaN(screenWidth)) {
      console.log('ERROR render() screenWidth !== number. screenWidth', screenWidth, ', trackScale', screenWidth, ', ', screenWidth);
    }
    ...
    if (isNaN(actualTrimmerWidth)) {
      console.log('ERROR render() actualTrimmerWidth !== number. boundedTrimTime', boundedTrimTime, ', totalDuration', totalDuration, ', screenWidth', screenWidth);
    }
    return (
